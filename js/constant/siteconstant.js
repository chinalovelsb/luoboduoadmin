...
angular.module('admin')
    .constant('DirectiveData', {
        companyTitle: ['序号', '公司名称', '公司行业', '地区', '融资规模', '认证状态', '冻结状态', '操作']
    })
    //公司相关
    .constant('CompanyConstant', {
            Approved: [
                {'type': null, 'name': '不限'},
                {'type': 0, 'name': "未认证"},
                {'type': 1, 'name': "已认证"}
    ...
    .constant('ArticleConstant', {
        'tabelTitle': [
            '序号', '图片', '标题', '类型', '创建者', '创建时间', '修改时间', '状态', '操作'
        ],
        'type': [
            {type: null, name: '全部'},
    ...
    //后台管理
    .constant('BackStageConstant', {
        roleTitle: ['ID', '角色', '操作'],
        managerTitle: ['ID', '登录名', '角色', '创建者', '创建时间', '更新人', '更新时间', '操作'],
        moduleTitle: ['ID', '名称', '模块对应url地址', '父模块ID', '模块类型', '数据更新时间', '更新人ID', '数据创建时间', '创建者ID', '操作']
    })
